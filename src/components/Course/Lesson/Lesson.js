		...
		return (
			<div className={s.lesson}>
				...
				{this.props.lesson.type === 1 ? 
					<div className={s.buttonHolder}><button onClick={() => { this.showAnswerBlock() }}>Show answer</button></div>				
				: null}

				{/* Showing like lesson when task completed */}
				...
				{/* Showing Complete lesson button if user logged at lesson */}
